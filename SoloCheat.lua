...
local Config = {
    ...
    LootLink = "https://loot-link.com/s?PCsMdk30", -- Ton lien Loot-Link
    Linkvertise = "https://linkvertise.com/ton_lien_ici", -- REMPLACE PAR TON LIEN LINKVERTISE
...
local function InitCheat()
    ...
    Title.Text = "  SoloCheat - V1 PRO (UNIVERSAL)"
    ...
    SkinLabel.Text = "SKINCHANGER SYSTEM (ECON)"
...
local function InitKeySystem()
    ...
    KTitle.Text = "SoloCheat Authentication"
    ...
    ValidBtn.Size = UDim2.new(0.28, 0, 0, 40)
    ValidBtn.Position = UDim2.new(0.06, 0, 0.65, 0)
